...
public class SceneGeometry : core.System
{
    ...
    public RenderTarget2D GetEmissiveBuffer() => EmissiveBuffer;
    
    public RenderTarget2D GetAbsorptionBuffer() => AbsorptionBuffer;

    public RenderTarget2D GetSDFBuffer() => SDFBuffer;
